...
CFLAGS=$(echo "-Wdate-time -D_FORTIFY_SOURCE=2 -g -fdebug-prefix-map=/dev/shm/python27/python2.7-2.7.15=. -Wformat -march=native -pipe -Wformat-security " | sed "s#$prefix_build#$prefix_real#")
VERSION="2.7"
LIBM="-lm"
LIBC=""
SYSLIBS="$LIBM $LIBC"
