...
build_time_vars = {'AC_APPLE_UNIVERSAL_BUILD': 0,
 ...
 'BLDSHARED': 'icc.pl -shared  -fno-strict-aliasing -fp-model strict -OPT:Olimit=0 -DNDEBUG -g  -O3 -Wall -Wstrict-prototypes -Wdate-time -D_FORTIFY_SOURCE=2 -g -fdebug-prefix-map=/dev/shm/python27/python2.7-2.7.15=. -Wformat -march=native -pipe -Wformat-security  -g -flto -fuse-linker-plugin -ffat-lto-objects',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 'CC': 'icc.pl',
 'CCSHARED': '-fPIC',
 'CFLAGS': '-fno-strict-aliasing -fp-model strict -OPT:Olimit=0 -DNDEBUG -g  -O3 -Wall -Wstrict-prototypes -Wdate-time -D_FORTIFY_SOURCE=2 -g -fdebug-prefix-map=/dev/shm/python27/python2.7-2.7.15=. -Wformat -march=native -pipe -Wformat-security  -g -flto -fuse-linker-plugin -ffat-lto-objects',
 'CFLAGSFORSHARED': '-fPIC',
 'CONFIGFILES': 'configure configure.ac acconfig.h pyconfig.h.in Makefile.pre.in',
 'CONFIGURE_CFLAGS': '-Wdate-time -D_FORTIFY_SOURCE=2 -g -fdebug-prefix-map=/dev/shm/python27/python2.7-2.7.15=. -Wformat -march=native -pipe -Wformat-security',
 'CONFIGURE_CPPFLAGS': '',
 'CONFIGURE_LDFLAGS': '',
 'CONFIG_ARGS': "'--enable-shared' '--prefix=/usr' '--enable-ipv6' '--enable-unicode=ucs4' '--with-dbmliborder=bdb:gdbm' '--with-system-expat' '--with-computed-gotos' '--with-system-ffi' 'CC=x86_64-linux-gnu-gcc' 'CFLAGS=-Wdate-time -D_FORTIFY_SOURCE=2 -g -fdebug-prefix-map=/dev/shm/python27/python2.7-2.7.15=. -Wformat -march=native -pipe -Wformat-security ' 'LDFLAGS=' 'CPP=icc.pl -E' 'PKG_CONFIG_PATH=/opt/intel/vtune_amplifier/include/pkgconfig/lib64:'",
 'CONFINCLUDEDIR': '/usr/include',
 'CONFINCLUDEPY': '/usr/include/python2.7',
 'COREPYTHONPATH': ':plat-linux2:lib-tk:lib-old',
 'COVERAGE_INFO': '/dev/shm/python27/python2.7-2.7.15/build-shared/coverage.info',
 'COVERAGE_REPORT': '/dev/shm/python27/python2.7-2.7.15/build-shared/lcov-report',
 ...
 'INSTALL_SHARED': '/usr/bin/install -m 555',
 'INSTSONAME': 'libpython2.7.so.1.0',
 'LDCXXSHARED': 'icc.pl -shared',
 'LDFLAGS': '',
 'LDLAST': '',
 'LDLIBRARY': 'libpython2.7.so',
 'LDLIBRARYDIR': '',
 'LDSHARED': 'icc.pl -shared  -fno-strict-aliasing -fp-model strict -OPT:Olimit=0 -DNDEBUG -g  -O3 -Wall -Wstrict-prototypes -Wdate-time -D_FORTIFY_SOURCE=2 -g -fdebug-prefix-map=/dev/shm/python27/python2.7-2.7.15=. -Wformat -march=native -pipe -Wformat-security  -g -flto -fuse-linker-plugin -ffat-lto-objects',
 'LIBC': '',
 ...
 'PYTHON_HEADERS': '\\',
 'PYTHON_OBJS': '\\',
 'PY_CFLAGS': '-fno-strict-aliasing -fp-model strict -OPT:Olimit=0 -DNDEBUG -g  -O3 -Wall -Wstrict-prototypes -Wdate-time -D_FORTIFY_SOURCE=2 -g -fdebug-prefix-map=/dev/shm/python27/python2.7-2.7.15=. -Wformat -march=native -pipe -Wformat-security  -g -flto -fuse-linker-plugin -ffat-lto-objects',
 'PY_CORE_CFLAGS': '-fno-strict-aliasing -fp-model strict -OPT:Olimit=0 -DNDEBUG -g  -O3 -Wall -Wstrict-prototypes -Wdate-time -D_FORTIFY_SOURCE=2 -g -fdebug-prefix-map=/dev/shm/python27/python2.7-2.7.15=. -Wformat -march=native -pipe -Wformat-security  -g -flto -fuse-linker-plugin -ffat-lto-objects -I. -IInclude -I../Include -fPIC -DPy_BUILD_CORE',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/dev/shm/python27/python2.7-2.7.15/build-shared:/opt/intel/lib/intel64:/opt/intel/compilers_and_libraries/linux/mpi/intel64/libfabric/lib:/opt/intel/compilers_and_libraries/linux/mpi/intel64/lib/release:/opt/intel/compilers_and_libraries/linux/mpi/intel64/lib:/opt/intel/tbb/lib/intel64/gcc4.7',
 'SCRIPTDIR': '/usr/lib',
 'SETPGRP_HAVE_ARG': 1,
 'SGI_ABI': '',
 'SHELL': '/bin/sh',
 ...
 'TESTPYTHON': 'LD_LIBRARY_PATH=/dev/shm/python27/python2.7-2.7.15/build-shared:/opt/intel/lib/intel64:/opt/intel/compilers_and_libraries/linux/mpi/intel64/libfabric/lib:/opt/intel/compilers_and_libraries/linux/mpi/intel64/lib/release:/opt/intel/compilers_and_libraries/linux/mpi/intel64/lib:/opt/intel/tbb/lib/intel64/gcc4.7 ./python -Wd -3 -E -tt',
 'TESTPYTHONOPTS': '',
 ...
 'abs_builddir': '/dev/shm/python27/python2.7-2.7.15/build-shared',
 'abs_srcdir': '/dev/shm/python27/python2.7-2.7.15/build-shared/..',
