...
build_time_vars = {'AC_APPLE_UNIVERSAL_BUILD': 0,
 ...
 'CONFIGURE_CPPFLAGS': '',
 'CONFIGURE_LDFLAGS': '',
 'CONFIG_ARGS': "'--prefix=/usr' '--enable-ipv6' '--enable-unicode=ucs4' '--with-dbmliborder=bdb:gdbm' '--with-system-expat' '--with-computed-gotos' '--with-system-ffi' '--with-pydebug' 'CC=x86_64-linux-gnu-gcc' 'CFLAGS=-Wdate-time -g -O0 -fdebug-prefix-map=/dev/shm/python27/python2.7-2.7.15=. -Wformat -march=native -pipe -Wformat-security' 'LDFLAGS=' 'CPP=icc.pl -E' 'PKG_CONFIG_PATH=/opt/intel/vtune_amplifier/include/pkgconfig/lib64:'",
 'CONFINCLUDEDIR': '/usr/include',
 'CONFINCLUDEPY': '/usr/include/python2.7_d',
 'COREPYTHONPATH': ':plat-linux2:lib-tk:lib-old',
 'COVERAGE_INFO': '/dev/shm/python27/python2.7-2.7.15/build-debug/coverage.info',
 'COVERAGE_REPORT': '/dev/shm/python27/python2.7-2.7.15/build-debug/lcov-report',
 ...
 'INSTSONAME': 'libpython2.7_d.a',
 'LDCXXSHARED': 'icc.pl -shared',
 'LDFLAGS': '',
 'LDLAST': '',
 'LDLIBRARY': 'libpython2.7_d.a',
 'LDLIBRARYDIR': '',
 ...
 'PY_CORE_CFLAGS': '-fno-strict-aliasing -fp-model strict -OPT:Olimit=0 -g -O0 -Wall -Wstrict-prototypes -Wdate-time -g -O0 -fdebug-prefix-map=/dev/shm/python27/python2.7-2.7.15=. -Wformat -march=native -pipe -Wformat-security  -Wdate-time -g -O0 -fdebug-prefix-map=/dev/shm/python27/python2.7-2.7.15=. -Wformat -march=native -pipe -Wformat-security -I. -IInclude -I../Include  -DPy_BUILD_CORE',
 ...
 'abs_builddir': '/dev/shm/python27/python2.7-2.7.15/build-debug',
 'abs_srcdir': '/dev/shm/python27/python2.7-2.7.15/build-debug/..',
